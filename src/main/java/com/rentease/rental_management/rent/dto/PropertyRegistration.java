...
public class PropertyRegistration
{
    ...
    @Size(min = 30, max = 5000, message = "Description cannot be less than 30 characters and more than 5000 characters.")
    ...
    @NotNull(message = "Property Floor cannot be null.")
    ...
    private Property.Parking parking;
